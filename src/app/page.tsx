        ...
        <section className="relative w-full py-24 md:py-32">
          <div className="container px-4 md:px-6 text-center">
            <div className="flex flex-col items-center space-y-6">
              <div className="p-1 rounded-full shadow-2xl shadow-primary/30">
              ...
              <div className="flex flex-col gap-4 min-[400px]:flex-row">
                <Button asChild size="lg" className="bg-accent text-accent-foreground shadow-lg hover:bg-accent/90 transition-opacity">
                  <Link href="/chat">
                    Get Free Security Analysis
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-primary text-primary hover:bg-primary/10 hover:text-primary/90">
                  <Link href="#features">
        ...
        <section id="features" className="w-full py-16 md:py-24 bg-background/50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
               <div className="inline-block px-4 py-1 text-sm font-semibold rounded-full bg-primary/10 text-primary">Key Features</div>
            ...
            <div className="grid max-w-6xl gap-8 mx-auto sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
               <div className="p-6 text-center transition-transform duration-300 transform bg-muted/50 rounded-xl shadow-lg hover:scale-105 hover:shadow-primary/20 border border-border">
